// Set answers
// B
var answerKey1 = [{ value: "q1_s1", answer: 0 }, {value: "q1_s2", answer: 1 }, { value: "q1_s3", answer: 0 }];
// D
var answerKey2 = [{ value: "q2_s1", answer: 0 }, {value: "q2_s2", answer: 0 }, { value: "q2_s3", answer: 0 }, { value: "q2_s4", answer: 1 }];
// C
var answerKey3 = [{ value: "q3_s1", answer: 1 }, {value: "q3_s2", answer: 0 }, { value: "q3_s3", answer: 1 }, { value: "q3_s4", answer: 0 }];
// B,C
var answerKey4 = [{ value: "q4_s1", answer: 1 }, {value: "q4_s2", answer: 1 }, { value: "q4_s3", answer: 0 }, { value: "q4_s4", answer: 1 }];

var answerMsgs = [
	"The premium chip and cut resistant compound provides a 5 percent longer tread life.",
	"The MICHELIN<sup>&reg;</sup> X<sup>&reg;</sup> WORKS<sup>&trade;</sup> Z has 5% better rolling resistance than the XZY<sup>&reg;</sup>3.",
	"The MICHELIN<sup>&reg;</sup> X<sup>&reg;</sup> WORKS<sup>&trade;</sup> Z has a full-width elastic protector ply and thicker cushion gum, which help prevent bruising and penetration of road hazards that lead to downtime.",
	"The MICHELIN<sup>&reg;</sup> X<sup>&reg;</sup> WORKS<sup>&trade;</sup> Z fights stone drilling with V-Channels, groove bottom protectors, and shock resistant protector ply."
];
var p = window.parent;
...
function checkIndex(questionObject){
	...
	$("#submitBtn, #nextBtn").css({ "top": currentQuestionObject.height() + $("#submitBtn").height() + 100} );
...
function nextQuestion() {
	...
	if( retryToggle ) {
		...
		if (currentQuestion >= 4){
			...
			$("#finishDisplay").show().addClass( "fade-in" );
			$(".headline").hide(); 
			$("#finishFeedbackImage").addClass( "fade-in" ).removeClass( "fade-out" );
...
window.onresize = function(){
 	$questions = $('.questions');
	currentQuestionObject = $($questions.get(currentQuestion));
	$("#submitBtn, #nextBtn").css({ "top": currentQuestionObject.height() + 100} );
	$("#feedbackMask").css({ "height": currentQuestionObject.outerHeight()});
};

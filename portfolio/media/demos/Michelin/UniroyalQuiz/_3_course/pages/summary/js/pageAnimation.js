...
function summary()
{
	...
	var fadeDelay = 0;
   	...
   	TweenLite.to($("#certificateid"), crossFadeTime, {css:{opacity:1.0}, delay:fadeDelay, ease:Quad.easeIn});	
	...
	TweenLite.to($("#print-cert"), crossFadeTime, {css:{opacity:1.0}, delay:fadeDelay+2.5, ease:Quad.easeIn});
	...
	TweenLite.to($(".badge-off"), .1, {css:{opacity:.75}, delay:fadeDelay+10, ease:Quad.easeOut, onComplete:badgeSound});

   	TweenLite.to($("#badge4_off"), crossFadeTime, {css:{opacity:0.0}, delay:fadeDelay+10.5, ease:Quad.easeOut});	
   	TweenLite.to($(".badge-on"), crossFadeTime/2, {css:{opacity:1.0}, delay:fadeDelay+10.2, ease:Quad.easeOut, onComplete:badgeBounce});	
}
...
{
	TweenMax.to($('#badge4_glint_'), .7, {y:"-=4", yoyo:true, repeat:-1, delay:0,ease:Quad.easeInOut});
}

            ...
            var choiceExtObj = new Ext.Panel({
                ...
                items: [
						...
						},
						{
						    ...
						    border: false,
						    html: '<img src="_2_skin/images/' + imgBase + '_' + imgDesignation + '.png" width="44" height="40" />'
						},
						{
						    flex: 1,
						    border: false,
                ...
                listeners: {
                    render: function (c) {
                        choice.isSelected = (choice.isSelected == null) ? false : choice.isSelected;
							c.el.on(
								'click', 
								function (e, t, o) {renderer.onChoiceClick(e, t, o, this);},
								this, 
								{ choiceObj: c.choiceObj }	
							);
                    },
					mouseover : function(c) { alert("mouseover") },
    				mouseout : function(c) { alert("mouseout")  }
                }
                    ...
                    if (!extCmp.reRendered) {
                        ...
                        setTimeout(
							function () {
								...
								/*$("#continue").stop().animate({opacity: "0"}, 'fast');*/
							}
						, 1);
				...
				items = [
						{
							...
							'<div style="width: 70%; margin: auto; position: relative; padding-top: 10%;">' +
									...
									//'<p class="mcLessonText" style="text-transform: none !important; line-height: 26px; font-style: normal !important; font-size: 17px !important;">' + completionData.passedText.htmlText + '</p><br>' +
				...
				items = [
						{
							...
							'<div style="width: 70%; margin: auto; position: relative; padding-top: 10%;">' +
									...
									'<div class="button" style="width: 200px"><a href="#" onClick="courseObj.gotoPageIndex(courseData.retakeAssessmentIndex); return false;">' + completionData.retakeTest.htmlText +'</a></div></div></div>'
						}/*,
						{
						    flex: 1,
						    layout: 'hbox',

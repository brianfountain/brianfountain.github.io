...
function summary()
{
	...
	TweenLite.to($(".badge-off"), .1, {css:{opacity:.75}, delay:fadeDelay+3.7, ease:Quad.easeOut, onComplete:badgeSound});

   	TweenLite.to($("#badge1_off"), crossFadeTime, {css:{opacity:0.0}, delay:fadeDelay+3.5, ease:Quad.easeOut});	
   	TweenLite.to($(".badge-on"), crossFadeTime/2, {css:{opacity:1.0}, delay:fadeDelay+3.7, ease:Quad.easeOut, onComplete:badgeBounce});	
}
...
{
	TweenMax.to($('#badge3_glint_'), .7, {y:"-=4", yoyo:true, repeat:-1, delay:0,ease:Quad.easeInOut});
}

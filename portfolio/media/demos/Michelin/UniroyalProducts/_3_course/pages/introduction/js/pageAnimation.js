...
function screenTwoTweens()
{
	...
	TweenLite.to($("#badge2_glint_"), 2.0, {css:{opacity:1.0, x:190, scaleX:1.2, scaleY:1.2}, delay:tween10time, ease:Elastic.easeOut});
	TweenMax.to($('#badge2_glint_'), 1.5, {y:"+=8", yoyo:true, repeat:-1, delay:tween10time+1,ease:Quad.easeInOut});

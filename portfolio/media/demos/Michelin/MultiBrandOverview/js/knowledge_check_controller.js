// Set answers
// A
var answerKey1 = [{ value: "q1_s1", answer: 1 }, {value: "q1_s2", answer: 0 }, { value: "q1_s3", answer: 0 }];
// C
var answerKey2 = [{ value: "q2_s1", answer: 0 }, {value: "q2_s2", answer: 0 }, { value: "q2_s3", answer: 1 }];
// A, B, C
var answerKey3 = [{ value: "q3_s1", answer: 1 }, {value: "q3_s2", answer: 1 }, { value: "q3_s3", answer: 1 }];

var answerMsgs = [
	"Michelin<sup>&reg;</sup> enables safety and on-time delivery with the total lowest cost of ownership for a fleet.",
	"UNIROYAL<sup>&reg;</sup> is a good match for any fleet not interested in retreading or seeks no more than one retread per casing.",
	"All our brands are supported by local Michelin representatives and local Field Engineers."
];

var p = window.parent;
var answerSteps = ["step1", "step2", "step3"];
...
function checkIndex(questionObject){
	...
	$("#submitBtn, #nextBtn").css({ "top": currentQuestionObject.height() + $("#submitBtn").height() + positionTweak} );
...
function nextQuestion() {
	...
	if( retryToggle ) {
		...
		if (currentQuestion >= 3){
			...
			/* 
			// We're forced to view a fuller conclusion page before reaching conclusion page now.
...
window.onresize = function(){
 	$questions = $('.questions');
	currentQuestionObject = $($questions.get(currentQuestion));
	$("#submitBtn, #nextBtn").css({ "top": currentQuestionObject.height() + positionTweak} );
	$("#feedbackMask").css({ "height": currentQuestionObject.outerHeight()});
};

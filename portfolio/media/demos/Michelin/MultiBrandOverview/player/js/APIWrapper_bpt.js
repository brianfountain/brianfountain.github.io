...
**
*******************************************************************************/
var bFinishCalled = false; //bpt var to ensure this doesn't get called twice. (since we call it from course, as well as upon window close)
function doLMSFinish() {
    if (bFinishCalled == false) {
        var api = getAPIHandle();
        if (api == null) {
            ...
            if (result.toString() != "true") {
                ...
                bFinishCalled = true; // st - putting this here to ensure if LMSFinish is successful, it won't be called again
            }
